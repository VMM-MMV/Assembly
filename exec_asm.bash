...
if [ "$1" = "-d" ]; then
    ...
    nasm -f elf64 -g "compare_numbers.asm" -o "compare_numbers.o"
    ...
    gcc -g -no-pie -nostartfiles "$1.o" concat.o len_of_input.o remove_space.o random_string.o replace_str.o compare_numbers.o average_of_list.o sort_list_desc.o reverse_arr.o list_sum.o -o "$1"
    ./"$1"
else
    # Assemble the assembly code
    nasm -f elf64 -g "$1.asm" -o "$1.o"
